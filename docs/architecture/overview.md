...
Status: Architecture
Version: independent unless stated otherwise
...
V0.1 implementation exists (Python package 0.1.3). This document is direction and invariants, not the testable spec. Derived V0.1 spec: docs/specs/v0.1.md. Do not fragment this overview further in the repository-normalization change.
...
This file is `docs/architecture/overview.md`. Further fragmentation is out of scope for the repository-normalization change.

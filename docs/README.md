...
| Where will V0.2 design live? | Rationale: [docs/design/v0.2/](design/v0.2/). Normative spec: [docs/specs/v0.2/](specs/v0.2/). Ingestion/spec-freeze evidence: [docs/reports/v0.2/](reports/v0.2/). Python executable contract remains [docs/specs/v0.1.md](specs/v0.1.md) until Rust kernel parity. |
...
Normative: [docs/architecture/overview.md](architecture/overview.md) (long-lived direction), [docs/specs/v0.1.md](specs/v0.1.md) (V0.1 Python-line contract), [docs/specs/v0.2/](specs/v0.2/) (V0.2 MUST/SHOULD/MAY). Design rationale is not a substitute for the V0.2 spec.
...
| `specs/` | Versioned testable contracts (MUST/SHOULD/MAY). `v0.1.md` is the Python-line kernel contract. `v0.2/` is the RIIR/V0.2 normative set. | Live smoke records, completion claims, design rationale (`design/`). |
